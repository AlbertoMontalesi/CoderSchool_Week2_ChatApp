# Homework 2 - *SmartChat*

**SmartChat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Alberto Montaleesi**
